...
description: Application integration guidance for protonemedia/laravel-verify-new-email.
license: MIT
metadata:
  author: ProtoneMedia
---
...
## Overview
Use `protonemedia/laravel-verify-new-email.` in a Laravel application.
...
- Activate when code references `protonemedia/laravel-verify-new-email.` classes, facades, config, or documented features.
